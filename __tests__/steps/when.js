...
const fs = require('fs')
const {GraphQL, registerFragments, registerFragment} = require('../lib/graphql')
...
const a_user_calls_getImageUploadUrl = async (user, extension, contentType) => {
    const getImageUploadUrl = `query MyQuery($extension: String, $contentType: String) {
      ...
      console.log(`[${user.username}] - got upload URL`)
      return url
}
...
const a_user_calls_getMyTimeline = async (user, limit, nextToken)=> {
  ...
  console.log(`[${user.username}] - got timeline`)
  return result
}
...
const a_user_calls_getLikes = async (user, userId, limit, nextToken)=> {
  ...
  console.log(`[${user.username}] - got likes`)
  return result
}
